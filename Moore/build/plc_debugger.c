 ...
 **/
extern __IEC_WORD_t CONFIG0__CONTROLLER_OUTPUT;
...
{&(CONFIG0__CONTROLLER_OUTPUT), WORD_ENUM},
...
{&(RES0__SVC.SENSOR_OUTPUT), WORD_P_ENUM},
{&(RES0__SVC.SSM_TRANSITIONS), WORD_P_ENUM},
...
{&(RES0__EM.CONTROLLER_OUTPUT), WORD_P_ENUM},
{&(RES0__EM.CURRENT_SUPERSTATE), INT_P_ENUM},
{&(RES0__EM.SENSOR_OUTPUT), WORD_P_ENUM},
{&(RES0__EM.SSM_TRANSITIONS), WORD_P_ENUM},
...
{&(RES0__AP.CONTROLLER_OUTPUT), WORD_P_ENUM},
...
{&(RES0__MP.CONTROLLER_OUTPUT), WORD_P_ENUM},
{&(RES0__MP.CURRENT_SUPERSTATE), INT_P_ENUM},
{&(RES0__MP.SENSOR_OUTPUT), WORD_P_ENUM},
 ...
 * Declare programs 
 **/
extern MOOREAUTOMATON RES0__INSTANCE0;
...
static dbgvardsc_t dbgvardsc[] = {
{&(RES0__INSTANCE0.A0), BOOL_ENUM},
{&(RES0__INSTANCE0.A1), BOOL_ENUM},
{&(RES0__INSTANCE0.B0), BOOL_ENUM},
{&(RES0__INSTANCE0.B1), BOOL_ENUM},
{&(RES0__INSTANCE0.C0), BOOL_ENUM},
{&(RES0__INSTANCE0.C1), BOOL_ENUM},
{&(RES0__INSTANCE0.D0), BOOL_ENUM},
{&(RES0__INSTANCE0.D1), BOOL_ENUM},
{&(RES0__INSTANCE0.PROX), WORD_ENUM},
{&(RES0__INSTANCE0.CURRENTSTATE), INT_ENUM},
{&(RES0__INSTANCE0.SENSOROUTPUT), WORD_ENUM},
{&(RES0__INSTANCE0.CONTROLLEROUTPUT), BYTE_ENUM},
{&(RES0__INSTANCE0.TESTVAR), INT_ENUM},
{&(RES0__INSTANCE0.COL), INT_ENUM},
{&(RES0__INSTANCE0.TMP), INT_ENUM},
{&(RES0__INSTANCE0.TMP0), DINT_ENUM},
{&(RES0__INSTANCE0.SUPERSTATE.EN), BOOL_ENUM},
{&(RES0__INSTANCE0.SUPERSTATE.ENO), BOOL_ENUM},
{&(RES0__INSTANCE0.SUPERSTATE.ROW), UINT_ENUM},
{&(RES0__INSTANCE0.SUPERSTATE.COL), UINT_ENUM},
{&(RES0__INSTANCE0.SUPERSTATE.OUT), INT_ENUM}
};

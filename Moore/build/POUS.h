...
typedef struct {
  ...
  // PROGRAM private variables - TEMP, private and located variables
  __DECLARE_VAR(__ARRAY_OF_WORD_12,VALUEMATRIX)
  __DECLARE_VAR(__ARRAY_OF_WORD_12,MASKMATRIX)
  __DECLARE_VAR(__ARRAY_OF_WORD_11,OUTPUTMATRIX)
  __DECLARE_EXTERNAL(WORD,CONTROLLER_OUTPUT)
  __DECLARE_EXTERNAL(INT,CURRENT_SUPERSTATE)
  __DECLARE_EXTERNAL(WORD,SENSOR_OUTPUT)
  __DECLARE_EXTERNAL(UINT,WDT)
  __DECLARE_EXTERNAL(WORD,SSM_TRANSITIONS)
  __DECLARE_EXTERNAL(INT,CURRENT_STATE)
  __DECLARE_EXTERNAL(UINT,AP_STEP)
  __DECLARE_VAR(UINT,COLUMN)
  __DECLARE_EXTERNAL(BOOL,OUT_AP)
  __DECLARE_EXTERNAL(BOOL,OUT_AM)
  __DECLARE_EXTERNAL(BOOL,OUT_B)
  __DECLARE_EXTERNAL(BOOL,OUT_C)
